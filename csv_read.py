...
def plot1():
    ...
    sns.barplot(x=met[:-2], y=metrics[:-2], palette='twilight_shifted', orient='h')
    ...
    plt.xlim(80,100)
    plt.tight_layout()
    plt.savefig("Results/res1",dpi=800)
    plt.show()
    ...
    plt.yticks()
    plt.tight_layout()
    plt.savefig("Results/res2",dpi=800)
    plt.show()
...
def res_plot2():
    ...
    sns.heatmap(mat, annot=True, cmap="twilight_shifted", fmt="d", xticklabels=["Homogenous","Speckled","Nucleolar","Centromere","Golgi","Nuclear Membrane"],yticklabels=["Homogenous","Speckled","Nucleolar","Centromere","Golgi","Nuclear Membrane"])
    plt.xlabel('Predicted labels')
    plt.ylabel('True labels')
    plt.xticks()
    plt.yticks()
    plt.tight_layout()
    plt.savefig("Results/confu.png", dpi=800)
    plt.show()
